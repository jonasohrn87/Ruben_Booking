...
namespace Ruben_Booking.API.Migrations
{
    ...
    [Migration("20241210234708_AddedBookingData")]
    partial class AddedBookingData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ruben_Booking.API.Database.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateFrom = new DateTime(2024, 12, 20, 0, 0, 0, 0, DateTimeKind.Local),
                            DateTo = new DateTime(2024, 12, 20, 23, 59, 59, 0, DateTimeKind.Local),
                            Participants = "[\"Hasse Jansson\"]",
                            PersonId = 1,
                            RoomId = 1
                        },
                        new
                        {
                            Id = 2,
                            DateFrom = new DateTime(2024, 12, 22, 0, 0, 0, 0, DateTimeKind.Local),
                            DateTo = new DateTime(2024, 12, 24, 23, 59, 59, 0, DateTimeKind.Local),
                            Participants = "[]",
                            PersonId = 2,
                            RoomId = 2
                        },
                        ...
                        {
                            Id = 3,
                            DateFrom = new DateTime(2024, 12, 19, 12, 0, 0, 0, DateTimeKind.Local),
                            DateTo = new DateTime(2024, 12, 19, 16, 0, 0, 0, DateTimeKind.Local),
                            Participants = "[]",
                            PersonId = 3,
                            RoomId = 3
                        });
